...
| Production deployment | **DARK — deployed, private, serving nobody** (2026-09-21): Railway environment `production` (`5e23ccb2`), six services live from branch `production` @ `2adda709`. Zero public domains, zero TCP proxies, no DNS change. Live HTTP validation NOT yet run — see `docs/PRODUCTION_DARK_PROOF.md` §7. Retired VPS artifacts stay quarantined under `deploy/legacy-vps/` |
...
PRODUCTION DEPLOYMENT: DARK (six services live from branch `production` @ 2adda709;
  no public surface; live HTTP validation outstanding)
DNS CHANGED: NO
A2A V1: NOT STARTED
