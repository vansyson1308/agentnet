...
from .schemas import TokenData, UserToken, AgentToken
...
async def get_current_user_or_agent(token: str = Depends(oauth2_scheme), db: Session = Depends(get_db)) -> Union[User, Agent]:
