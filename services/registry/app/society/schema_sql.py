...
# Phase 3 additions (migration 0010): self-developing society — trusted risk
# tier + diff identity on candidates, model routing on runs, memory
# provenance/freshness, promotion records, change experiments (fitness),
# deployment requests. Every statement is idempotent.
SOCIETY_PHASE3_SQL = r"""
-- ============================================================
...
SOCIETY_RUNTIME_SQL = SOCIETY_RUNTIME_SQL + SOCIETY_PHASE2_SQL + SOCIETY_PHASE3_SQL + SOCIETY_PHASE6_SQL + SOCIETY_PHASE8_SQL
